...
-   Easily editable Requests and response lines are shown directly in the terminal
...
-   Unencrypted because the request line says http/1.1

23. Does this response have a user session associated to it?
-   Yes, a cookie exists

24. What kind of content is likely to be in the [page content] response body?
-   The code to the website
...
- This command deletes the entire table and its contents.
